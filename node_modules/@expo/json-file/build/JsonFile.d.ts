...
export default class JsonFile<TJSONObject extends JSONObject> {
    ...
    mergeAsync(sources: Partial<TJSONObject> | Array<Partial<TJSONObject>>, options?: Options<TJSONObject>): Promise<TJSONObject>;
...
declare function mergeAsync<TJSONObject extends JSONObject>(file: string, sources: Partial<TJSONObject> | Array<Partial<TJSONObject>>, options?: Options<TJSONObject>): Promise<TJSONObject>;
