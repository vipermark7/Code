...
var _AndroidIntentFilters = _interopRequireDefault(require("../../detach/AndroidIntentFilters"));
...
describe('renderIntentFilters', () => {
  it('renders intent filters', () => {
    ...
    expect(normalizeWhitespace((0, _AndroidIntentFilters.default)(intentFilters))).toEqual(normalizeWhitespace([`<intent-filter>
