...
var IosAssetArchive = _interopRequireWildcard(require("./IosAssetArchive"));
...
var IosLaunchScreen = _interopRequireWildcard(require("./IosLaunchScreen"));
...
var IosLocalization = _interopRequireWildcard(require("./IosLocalization"));
...
async function configureAsync(context) {
  ...
  try {
    ...
    if (context.type === 'user') {
      ...
      try {
        await AssetBundle.bundleAsync(context, context.data.manifest.bundledAssets, supportingDirectory, context.data.manifest.sdkVersion === '24.0.0');
      } catch (e) {
