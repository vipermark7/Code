...
exports.default = (() => {
  var _ref = _asyncToGenerator(function* (appPath, packageName, packageVersion, options = {}) {
    const packageLockJsonExists = yield (_fsExtra || _load_fsExtra()).default.pathExists(_path.default.join(appPath, 'package-lock.json'));
    const yarnExists = yield (0, (_commandExists || _load_commandExists()).default)('yarnpkg');
