...
function userSettingsFile() {
  ...
  try {
    ...
    if ((_fsExtra || _load_fsExtra()).default.statSync(oldFile).isFile()) {
      (_fsExtra || _load_fsExtra()).default.renameSync(oldFile, file);
    }
  } catch (e) {
...
function dotExpoHomeDirectory() {
  ...
  if (process.env.__UNSAFE_EXPO_HOME_DIRECTORY) {
    ...
    try {
      ...
      if ((_fsExtra || _load_fsExtra()).default.statSync(oldDirPath).isDirectory()) {
        (_fsExtra || _load_fsExtra()).default.renameSync(oldDirPath, dirPath);
      }
    } catch (e) {
      // no old directory, continue
    }
  ...
  if (!mkdirped) {
    (_fsExtra || _load_fsExtra()).default.mkdirpSync(dirPath);
    mkdirped = true;
  }
  return dirPath;
}
