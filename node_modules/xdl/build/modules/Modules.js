...
function getDetachableModulesForPlatformAndSdkVersion(platform, sdkVersion) {
  return getAllForPlatform(platform).filter(moduleConfig => {
    return moduleConfig.isNativeModule && moduleConfig.detachable && (sdkVersion === 'UNVERSIONED' || (_semver || _load_semver()).default.satisfies(sdkVersion, moduleConfig.sdkVersions));
  });
}
