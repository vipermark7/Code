...
var AndroidUploader = function (_BaseUploader) {
  ...
  (0, (_createClass2 || _load_createClass()).default)(AndroidUploader, [{
    ...
    value: function _ensureExperienceIsValid(exp) {
      if (!(_lodash || _load_lodash()).default.has(exp, 'android.package')) {
          ...
          while (1) {
            switch (_context4.prev = _context4.next) {
              case 0:
                ...
                _context4.next = 5;
                return (0, (_utils || _load_utils()).runFastlaneAsync)(fastlane.supply_android, [path, androidPackage, key, track], {}, true);
