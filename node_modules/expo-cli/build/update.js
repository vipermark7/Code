    ...
    return (_regenerator || _load_regenerator()).default.wrap(function _callee$(_context) {
      while (1) {
        switch (_context.prev = _context.next) {
          case 0:
            _context.next = 2;
            return ModuleVersionChecker.checkAsync();
...
var ModuleVersionChecker = (_xdl || _load_xdl()).ModuleVersion.createModuleVersionChecker((_package || _load_package()).default.name, (_package || _load_package()).default.version);
