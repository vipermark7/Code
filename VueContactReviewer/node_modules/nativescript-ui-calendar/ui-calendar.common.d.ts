...
export declare enum CalendarSelectionShape {
    Round = "Round",
    Square = "Square",
    None = "None"
}
export declare enum CalendarEventsViewMode {
    None = "None",
    Inline = "Inline",
    Popover = "Popover"
}
...
export declare enum CalendarTransitionMode {
    None = "None",
    Slide = "Slide",
    Stack = "Stack",
    Flip = "Flip",
 ...
 * Font styles
 */
export declare enum CalendarFontStyle {
    /**
    * Regular font style
    */
    Normal = "Normal",
...
*/
export declare enum CalendarCellAlignment {
    /**
...
export declare class CalendarMonthViewStyle extends ViewBase {
    ...
    protected onSelectionShapeChanged(oldValue: CalendarSelectionShape, newValue: CalendarSelectionShape): void;
...
export declare class MonthCellStyle extends ViewBase {
    ...
    protected onDayFontStyleChanged(oldValue: CalendarFontStyle, newValue: CalendarFontStyle): void;
    ...
    protected onDayNameFontStyleChanged(oldValue: CalendarFontStyle, newValue: CalendarFontStyle): void;
    ...
    protected onMonthNameFontStyleChanged(oldValue: CalendarFontStyle, newValue: CalendarFontStyle): void;
...
export declare class CellStyle extends ViewBase {
    ...
    protected onCellTextFontStyleChanged(oldValue: CalendarFontStyle, newValue: CalendarFontStyle): void;
...
export declare class DayEventsViewStyle extends ViewBase {
    ...
    static timeLabelFontStyleProperty: Property<DayEventsViewStyle, CalendarFontStyle>;
    private onTimeLabelFontStylePropertyChanged;
    protected onTimeLabelFontStyleChanged(oldValue: CalendarFontStyle, newValue: CalendarFontStyle): void;
    ...
    static timeLinesColorProperty: Property<DayEventsViewStyle, Color>;
...
export declare class DayCellStyle extends CellStyle {
    ...
    protected onEventFontStyleChanged(oldValue: CalendarFontStyle, newValue: CalendarFontStyle): void;
...
export declare class InlineEventCellStyle extends ViewBase {
    ...
    protected onTimeFontStyleChanged(oldValue: CalendarFontStyle, newValue: CalendarFontStyle): void;
...
export declare class RadCalendar extends View {
    ...
    protected onSelectionModeChanged(oldValue: CalendarSelectionMode, newValue: CalendarSelectionMode): void;
    protected onTransitionModeChanged(oldValue: CalendarTransitionMode, newValue: CalendarTransitionMode): void;
    protected onViewModeChanged(oldValue: CalendarViewMode, newValue: CalendarViewMode): void;
    protected onEventsViewModeChanged(oldValue: CalendarEventsViewMode, newValue: CalendarEventsViewMode): void;
