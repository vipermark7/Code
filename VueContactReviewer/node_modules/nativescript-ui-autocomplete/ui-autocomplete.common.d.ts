...
export declare enum AutoCompleteDisplayMode {
    Tokens = "Tokens",
    Plain = "Plain"
}
export declare enum AutoCompleteSuggestMode {
    Suggest = "Suggest",
    Append = "Append",
    SuggestAppend = "SuggestAppend"
}
export declare enum AutoCompleteLayoutMode {
    Horizontal = "Horizontal",
    Wrap = "Wrap"
}
export declare enum AutoCompleteCompletionMode {
    StartsWith = "StartsWith",
    Contains = "Contains"
}
export declare enum AutoCompleteViewType {
    ItemView = "ItemView"
}
...
export declare class RadAutoCompleteTextView extends View {
    ...
    static displayModeProperty: Property<RadAutoCompleteTextView, AutoCompleteDisplayMode>;
    private onDisplayModePropertyChanged;
    protected onDisplayModeChanged(oldValue: AutoCompleteDisplayMode, newValue: AutoCompleteDisplayMode): void;
    static completionModeProperty: Property<RadAutoCompleteTextView, AutoCompleteCompletionMode>;
    private onCompletionModePropertyChanged;
    protected onCompletionModeChanged(oldValue: AutoCompleteCompletionMode, newValue: AutoCompleteCompletionMode): void;
    static layoutModeProperty: Property<RadAutoCompleteTextView, AutoCompleteLayoutMode>;
    private onLayoutModePropertyChanged;
    protected onLayoutModeChanged(oldValue: AutoCompleteLayoutMode, newValue: AutoCompleteLayoutMode): void;
    static suggestModeProperty: Property<RadAutoCompleteTextView, AutoCompleteSuggestMode>;
    private onSuggestModePropertyChanged;
    protected onSuggestModeChanged(oldValue: AutoCompleteSuggestMode, newValue: AutoCompleteSuggestMode): void;
