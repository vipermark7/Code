...
var fragment_transitions = require('tns-core-modules/ui/frame/fragment.transitions');
...
var ref$1 = require('tns-core-modules/platform');
  ...
  methods: {
    ...
    replace: function replace(entry) {
      ...
      if (platform.isIOS) {
        ...
        var newControllers = NSMutableArray.alloc().initWithArray(
          frame$$1._ios.controller.viewControllers
        );
        ...
        fragment_transitions._setAndroidFragmentTransitions(
          animated,
  ...
  install: function install(Vue) {
    ...
    Vue.prototype.$navigateTo = function(component, options) {
      ...
      return new Promise(function (resolve) {
        ...
        frame$$1.navigate(Object.assign({}, options, { create: function () { return page; } }));
        resolve(page);
      })
    };
  }
...
var ElementNode = /*@__PURE__*/(function (ViewNode$$1) {
...
var CommentNode = /*@__PURE__*/(function (ElementNode$$1) {
...
var TextNode = /*@__PURE__*/(function (ViewNode$$1) {
...
var DocumentNode = /*@__PURE__*/(function (ViewNode$$1) {
  ...
  install: function install(Vue) {
    ...
    Vue.prototype.$showModal = function(component, options) {
      ...
      return new Promise(function (resolve) {
        ...
        this$1.$el.nativeView.showModal(
          modalPage,
          null,
          closeCb,
          options.fullscreen
...
console.log = (function(log, inspect, Vue$$1) {
  return function() {
    ...
    return log.call.apply(
      log, [ this ].concat( Array.prototype.map.call(args, function(arg) {
        return inspect(arg, {
          depth: 2,
