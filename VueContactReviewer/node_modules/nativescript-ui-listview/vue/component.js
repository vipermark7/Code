...
exports.default = {
    ...
    computed: {
        scrollDirection: function () {
            return this.orientation !== 'vertical' ? __1.ListViewScrollDirection.Horizontal : __1.ListViewScrollDirection.Vertical;
        },
    },
    watch: {
        items: {
            ...
            switch (itemType) {
                ...
                case __1.ListViewViewType.LoadOnDemandView:
                    if (~availableTemplates.indexOf('loadondemand')) {
                        return _this.$templates.patchTemplate('loadondemand', _this.$parent);
                    }
                    break;
            }
        });
    ...
    methods: {
        ...
        updateGroupViewTemplate: function (args) {
            var templateName = "group";
            if (~this.$templates.getAvailable().indexOf(templateName)) {
                var context = this.getItemContext(args.view.bindingContext);
        ...
        onItemLoadingInternal: function (args) {
            if (args.index < 0) {
