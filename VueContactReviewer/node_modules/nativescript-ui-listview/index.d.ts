 ...
 * and the foreground of the Pull-to-Refresh indicator.
 */
export class PullToRefreshStyle {
    ...
    /**
     * Gets or sets the background color of the pull-to-refresh indicator and container.
     */
...
export class ListViewLinearLayout extends ListViewLayoutBase {
    ...
    */
    static scrollDirectionProperty: Property<ListViewLinearLayout, ListViewScrollDirection>;
    /**
    ...
    */
    static itemInsertAnimationProperty: Property<ListViewLinearLayout, ListViewItemAnimation>;
    /**
    ...
    */
    static itemDeleteAnimationProperty: Property<ListViewLinearLayout, ListViewItemAnimation>;
    /**
...
export class RadListView extends View {
    ...
    */
     ...
     */
    static reorderModeProperty: Property<RadListView, ListViewReorderMode>;
    ...
    */
    static selectionBehaviorProperty: Property<RadListView, ListViewSelectionBehavior>;
    ...
    */
    ...
    /**
     * Used internally inside the Angular directives
     * Called when a wrapper View of any of the templates is added to the RadListView.
     * We wrap the `itemTemplate` on Android to support simple `Label` template with `margin` set,
     * and we wrap the first `groupTemplate` on iOS to achieve support for `headerItemTemplate` with grouping enabled.
     */
    ...
    */
    @Deprecated
    static scrollPositionProperty: Property<RadListView, ListViewScrollPosition>;
