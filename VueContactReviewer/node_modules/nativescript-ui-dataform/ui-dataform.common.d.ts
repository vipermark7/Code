...
export declare enum DataFormCommitMode {
    Immediate = "Immediate",
    OnLostFocus = "OnLostFocus",
    Manual = "Manual"
}
export declare enum DataFormValidationMode {
    Immediate = "Immediate",
    OnLostFocus = "OnLostFocus",
    Manual = "Manual"
}
export declare enum DataFormLabelPosition {
    Left = "Left",
    Top = "Top"
}
export declare enum DataFormEditorType {
    Text = "Text",
 ...
 * Font styles
 */
export declare enum DataFormFontStyle {
    Normal = "Normal",
    Bold = "Bold",
    Italic = "Italic",
...
export declare class RadDataForm extends View implements AddArrayFromBuilder {
    ...
    protected _onCommitModePropertyChanged(oldValue: DataFormCommitMode, newValue: DataFormCommitMode): void;
    protected _onValidationModePropertyChanged(oldValue: DataFormValidationMode, newValue: DataFormValidationMode): void;
...
export declare class DataFormStyleBase extends ViewBase {
    ...
    protected onSeparatorColorChanged(oldValue: Color, newValue: Color): void;
    ...
    protected onLabelFontStyleChanged(oldValue: DataFormFontStyle, newValue: DataFormFontStyle): void;
}
...
export declare class PropertyEditorStyle extends DataFormStyleBase {
    ...
    protected onLabelPositionChanged(oldValue: DataFormLabelPosition, newValue: DataFormLabelPosition): void;
...
export declare class EntityProperty extends View implements AddArrayFromBuilder {
    ...
    protected onAutoCompleteDisplayModeChanged(oldValue: AutoCompleteDisplayMode, newValue: AutoCompleteDisplayMode): void;
    protected onNameChanged(oldValue: string, newValue: string): void;
...
export declare class PropertyEditor extends View {
    ...
    protected onTypeChanged(oldValue: DataFormEditorType, newValue: DataFormEditorType): void;
